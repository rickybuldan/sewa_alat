    ...
    <div class="row relative overflow-x-auto shadow-md sm:rounded-lg border-custom shadow-custom">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <caption class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                Daftar Pengembalian
                <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">List daftar pengembalian yang membutuhkan persetujuan oleh admin</p>
            </caption>
            ...
            <tbody>
                @foreach ($pengembalian as $index => $sewa)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <a href="{{ route('admin.pengembalian.show', $sewa->id) }}" class="px-4 py-2 font-medium text-white bg-blue-500 rounded-md dark:text-blue-500 hover:underline">Detail</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
            @else
                <p class="p-4 text-red-500 dark:text-gray-400 bg-white border-b border-custom-392676">Tidak ada pengembalian yang menunggu persetujuan.</p>
            @endif
        </table>
