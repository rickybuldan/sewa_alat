...
<div class="container items-center justify-center pt-3 xl:pl-60 lg:pl-35">
    <div class="bg-white rounded-xl shadow-lg border-custom shadow-custom relative overflow-x-auto p-6 max-w-2xl pl-10">
        <caption class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
            ...
            <h2 class="text-xl font-semibold text-gray-900">Tambah Kendaraan</h2>           
            <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Form Tambah Kendaraan Pengantar PT. Sarkon Bangun Nusantara</p>
        </caption>
        <form action="{{ route('admin.kendaraanPengantar.store') }}" class="max-w-xl " method="POST">
            @csrf
            <div class="mb-5">
                <label for="jenis" class="block mb-2 text-sm font-medium text-black dark:text-black">Jenis kendaraan</label>
            ...
            <div class="mb-5">
                <label for="no_pol" class="block mb-2 text-sm font-medium text-black dark:text-black">Plat nomor</label>
